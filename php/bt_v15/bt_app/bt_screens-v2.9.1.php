<?php   require_once("../../config.php");
	...
	$nextViewStyle = fnGetReqVal("nextViewStyle", "", $myRequestVars);
		if($nextViewStyle != "") $viewStyle = $nextViewStyle;
			if($viewStyle == "") $viewStyle = "gridView";
	...
	$searchPluginTypeUniqueId = fnGetReqVal("searchPluginTypeUniqueId", "", $myRequestVars);
	...
	if(strpos($sortColumn, "U.") > -1 || strpos($sortColumn, "F.") > -1){
                            ...
                            <tr>
                                ...
                                <td nowrap style='padding-left:10px;'>
                                    ...
                                    <div style='float:right;margin:0px;'>
                                        ...
                                        <select name="searchPluginTypeUniqueId" id="searchPluginTypeUniqueId" onchange="document.forms[0].submit();" style="width:200px;margin:0px;display:inline;vertical-align:middle;overflow:hidden;">
                                ...
                                while($row = mysql_fetch_array($res2)){
									...
									echo "\n\n<tr class='" . $css . "'>";
										...
										echo "\n<td class='data' style='vertical-align:middle;padding-left:5px;padding-top:5px;white-space:normal;border-bottom:1px solid #999999;'>";
											echo "<a href='bt_pickerPluginDetails.php?pluginGuid=" . $pluginGuid . $qVars . "' rel=\"shadowbox;height=550;width=950\">" . $displayAs . "</a> <i>(" . $row["countOfScreens"] . ")</i>";
                                ...
                                if($totalRecs > 0){
                                    ...
                                    if($res){
                                        ...
                                        $cnt = 0;
                                            ...
                                            $pluginScreenURL = "../.." . APP_DATA_DIRECTORY . "/plugins" . $webDirectoryName . "/?BT_itemId=" . $BT_itemId . $qVars;
            
                                            $pad = "&nbsp;&nbsp;|&nbsp;&nbsp;";
                                            echo "\n\n<tr id='i_" . $BT_itemId . "' class='" . $css . "'>";
                                                echo "\n<td class='data' style='padding-left:5px;'>";
                                                    echo "<a href=\"" . $pluginScreenURL . "\">" . $nickname . "</a>";
                                                echo "</td>";
                                                echo "\n<td class='data' style='padding-left:10px;'>" . $itemTypeLabel . "</td>";
                                                echo "\n<td class='data' style='padding-left:10px;'>" . $modLabel . "</td>";
												...
												echo "\n<td class='data' style='padding-left:10px;text-align:right;padding-right:10px;'>";
                                                    echo "<a href='" . $scriptName . "?unused=true&BT_itemId=" . $BT_itemId . $qVars . "&command=delete'>delete</a>";
                                                echo "</td>";
                                            	*/
                            ...
                            if($totalRecs > 0){
                                ...
                                if($res){
                                    ...
                                    while($row = mysql_fetch_array($res)){
                                        ...
                                        echo "\n<div class='pluginBox' style='cursor:pointer;' onClick=\"document.location.href='" . $pluginScreenURL . "';return false;\">";
                                            echo "\n<div class='pluginIcon'>";
												echo "<img src='../.." . APP_DATA_DIRECTORY . "/plugins" . $webDirectoryName . "/icon.png'>";
                                            echo "</div>";    
